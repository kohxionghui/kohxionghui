...
📖 My Philosophy - I believe that a tool is only truly ultilised when a user truly understands both its purpose and its limitations. Software should be worthy of the hardware it runs on and I will try to achieve that standard in my work as well. My journey has taken me from Digital Game Art to the Republic of Singapore Navy to a years Retail Associate experience at COURTS, and now to Computer Science, looking to always master the tools and knowledge that I am using.
