...
📖 My Philosophy
I believe that a tool is only truly ultilised when a user truly understands its purpose and its limitations. Software should be worthy of the hardware it runs on. And I will try to achieve that standard in my work as well. My journey has taken me from the Republic of Singapore Navy to Digital Game Art, and now to Computer Science, looking to always master the tools that I am using.
